...
class QA_chain_self():
    ...
    # 问题: {question}
    # 有用的回答:"""
    default_template_rq="""Use the following context to answer the last question. If you don't know the answer, just say you don't know and don't try to make up an answer. Limit your response to three sentences at most. Keep the answer as concise as possible. Always end your response with "Thank you for your question!" {context} Question: {question} Helpful Answer:"""
